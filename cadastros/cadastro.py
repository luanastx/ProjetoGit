...
while True:
    ...
    if op == 1:
        ...
        for pessoa in funcionario:
            for i in pessoa:
                print(
                    f'{i[0]} - Nome do funcionário: {i[1]}. Código do funcionário: {i[0]}. Data de admissão: {i[2]}. Salário do funcionário: {i[3]}.')

    elif op == 3:
        print('Digite o código do funcionario que você deseja apagar.')
